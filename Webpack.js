...
if (Boolean(webpackChunkdiscord_app.Aqua_gm)) module.exports = webpackChunkdiscord_app.Aqua_gm;
else {
    const webpackExports = webpackChunkdiscord_app.push([[Symbol("Aqua")], {}, (e) => e]);
    ...
    webpackChunkdiscord_app.Aqua_gm = { find, getLazy };
    module.exports = {
        find,
        findAll,
        getLazy,
